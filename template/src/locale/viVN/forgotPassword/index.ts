export default {
  "forgot.password.title": "Cấp lại mật khẩu",
  ...
  "forgot.password.button.accept": "Cập nhật lại mật khẩu",
  "forgot.password.email.not.exit": "Email không tồn tại",
  "forgot.password.email.invalid": "Email không phải là một email hợp lệ!",
  "forgot.password.identification": "Mã xác thực",
  "forgot.password.identification.invalid": "Vui lòng nhập mã xác thực",
};
